...
export const playIcon = (color: string = 'black') => {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={darkColors.BUTTON_BORDER} height="40px" width="40px"  id="Capa_1" viewBox="0 0 17.804 17.804" >
            <G>
                <G id="c98_play">
